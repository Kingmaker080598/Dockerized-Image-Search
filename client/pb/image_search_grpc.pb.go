...
const (
	ImageSearchService_SearchImage_FullMethodName = "/ImageSearchService/SearchImage"
)
...
type ImageSearchServiceClient interface {
	SearchImage(ctx context.Context, in *ImageServiceRequest, opts ...grpc.CallOption) (*ImageServiceReply, error)
}
...
func (c *imageSearchServiceClient) SearchImage(ctx context.Context, in *ImageServiceRequest, opts ...grpc.CallOption) (*ImageServiceReply, error) {
	out := new(ImageServiceReply)
	err := c.cc.Invoke(ctx, ImageSearchService_SearchImage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ImageSearchServiceServer interface {
	SearchImage(context.Context, *ImageServiceRequest) (*ImageServiceReply, error)
...
func (UnimplementedImageSearchServiceServer) SearchImage(context.Context, *ImageServiceRequest) (*ImageServiceReply, error) {
...
func _ImageSearchService_SearchImage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImageSearchServiceServer).SearchImage(ctx, req.(*ImageServiceRequest))
	}
...
var ImageSearchService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ImageSearchService",
